...
void testUpdatePriorities() {
    ...
    cout << "Testing update priorities" << endl;
    ...
    cout << "Test update priorities succeeded!" << endl;
}

void testConstructors(){
    cout << "testin binary constructors" << endl;
    vector<int> data {1, 7, 2, 3, 8, 100, 6, 0};
    //BinaryPQ<const int*, IntPtrComp> pq {data.begin(), data.end()};
...
void testPairing() {
...

    {
        ...
        cout << "Testing basic methods" << endl;
        ...
        PairingPQ<int> pq5 {data2.cbegin(), data2.cend()};
        auto temp = pq5.addNode(6);
        pq5.updateElt(temp, 11);
        assert(pq5.top() == 11);
        ...
        PairingPQ<int> pq6 {data2.cbegin(), data2.cend()};
        pq6.push(20);
        assert(pq6.top() == 20);
        pq6.push(15);
        assert(pq6.top() == 20);
        PairingPQ<int> pq7 = pq6;
        PairingPQ<int> pq8 {pq7};
        assert(pq7.size() == 5);
        assert(pq7.top() == 20);
        assert(pq8.size() == 5);
        assert(pq8.top() == 20);
        ...
        PairingPQ<int> pq9;
        auto temp2 = pq9.addNode(11);
        assert(pq9.top() == 11);
        pq9.updateElt(temp2, 13);
        assert(pq9.top() == 13);
        assert(pq9.size() == 1);
        ...
        PairingPQ<int> pq10 {data3.cbegin(), data3.cend()};
        pq10.pop();
        auto temp3 = pq10.addNode(6);
        assert(pq10.top() == 6);
        pq10.updateElt(temp3, 1);
        assert(pq10.top() == 1);
        pq10.push(11);
        assert(pq10.top() == 11);
        pq10.updateElt(temp3, 20);
        assert(pq10.top() == 20);
        temp3 = pq10.addNode(5);
        pq10.updateElt(temp3, 21);
        assert(pq10.top() == 21);
        ...
        PairingPQ<int> pq11 {data4.cbegin(), data4.cend()};
        assert(pq11.top() == 10);
        auto temp4 = pq11.addNode(20);
        pq11.updateElt(temp4, 12);
        assert(pq11.top() == 12);
        pq11.updateElt(temp4, 3);
        assert(pq11.top() == 10);
        pq11.pop();
        assert(pq11.top() == 9);
        PairingPQ<int> pq12 = pq11;
        PairingPQ<int> pq13{pq11};
        pq11.pop();
        pq12.pop();
        pq13.pop();
        assert(pq11.top() == 8);
...
int main() {
    ...
    uint32_t choice {};
    std::cin >> choice;
    const PQType pqType = types.at(static_cast<size_t>(choice));
